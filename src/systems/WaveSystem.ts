...
export const WAVES: IWaveConfig[] = [
  ...
  { count: 1,  pool: [],                   hpMult: 1.0,  speedMult: 0.55, bossId: 143, bossHpMult: 22 },
  ...
  { count: 1,  pool: [],                   hpMult: 1.0,  speedMult: 0.5,  bossId: 150, bossHpMult: 70 },
  ...
  { count: 1,  pool: [],                   hpMult: 1.0,  speedMult: 0.45, bossId: 151, bossHpMult: 110 },
  ...
  { count: 1,  pool: [],                       hpMult: 1.0,  speedMult: 0.5,  bossId: 130, bossHpMult: 140 },
  ...
  { count: 1,  pool: [],                           hpMult: 1.0,  speedMult: 0.5,  bossId: 149, bossHpMult: 170 },
  ...
  { count: 1,  pool: [],                           hpMult: 1.0,  speedMult: 0.55, bossId: 65, bossHpMult: 200 },
  { count: 30, pool: [16, 19, 10, 13, 25, 50, 60, 92], hpMult: 11.5, speedMult: 1.9 },
  { count: 32, pool: [25, 39, 35, 60, 92, 74, 66],     hpMult: 12.0, speedMult: 1.95 },
  { count: 32, pool: [60, 92, 66, 74, 50, 25, 39, 19], hpMult: 12.5, speedMult: 2.0 },
  { count: 34, pool: [92, 25, 39, 60, 74, 66, 50],     hpMult: 13.0, speedMult: 2.0 },
  { count: 1,  pool: [],                               hpMult: 1.0,  speedMult: 0.5,  bossId: 9, bossHpMult: 240 },
  { count: 34, pool: [10, 13, 16, 19, 25, 50, 60, 92], hpMult: 13.5, speedMult: 2.05 },
  { count: 36, pool: [25, 39, 35, 60, 92, 74, 66, 19], hpMult: 14.0, speedMult: 2.1 },
  { count: 36, pool: [60, 92, 66, 74, 50, 25, 39],     hpMult: 14.5, speedMult: 2.1 },
  { count: 38, pool: [92, 74, 50, 60, 25, 66, 39],     hpMult: 15.0, speedMult: 2.15 },
  { count: 1,  pool: [],                               hpMult: 1.0,  speedMult: 0.5,  bossId: 6, bossHpMult: 280 },
  { count: 38, pool: [10, 13, 25, 50, 60, 92, 66, 74], hpMult: 15.5, speedMult: 2.2 },
  { count: 40, pool: [25, 39, 35, 60, 92, 74, 66, 50], hpMult: 16.0, speedMult: 2.25 },
  { count: 40, pool: [60, 92, 66, 74, 50, 25, 39, 19], hpMult: 16.5, speedMult: 2.3 },
  { count: 42, pool: [92, 25, 39, 60, 74, 66, 50, 35], hpMult: 17.0, speedMult: 2.35 },
  { count: 1,  pool: [],                               hpMult: 1.0,  speedMult: 0.5,  bossId: 3, bossHpMult: 320 },
  { count: 42, pool: [25, 60, 92, 66, 74, 50, 19, 39], hpMult: 17.5, speedMult: 2.4 },
  { count: 44, pool: [25, 39, 60, 92, 74, 66, 50],     hpMult: 18.0, speedMult: 2.45 },
  { count: 44, pool: [60, 92, 66, 74, 50, 25, 39, 35], hpMult: 18.5, speedMult: 2.5 },
  { count: 46, pool: [92, 25, 39, 60, 74, 66, 50, 19], hpMult: 19.0, speedMult: 2.5 },
  { count: 1,  pool: [],                               hpMult: 1.0,  speedMult: 0.55, bossId: 150, bossHpMult: 400 },
];
...
export class WaveSystem {
  ...
  private spawnBoss(cfg: IWaveConfig) {
    ...
    const baseHp = 60 + this.state.wave * 18;
